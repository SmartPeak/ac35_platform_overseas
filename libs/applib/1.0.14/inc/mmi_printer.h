...
typedef struct
{
    ...
    int printGray; 		                    ///<print gray level(heat time.Value range:2000-5000)
    te_printer_heat_point printHeatpoint;   ///<print heat point
    int printStep; 		                    ///<print step delay time(Value range:400-1200)
    int fontreverse;                        ///<print font reverse time(Value range:0,1)
